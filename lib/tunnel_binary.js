...
function TunnelBinary(httpTunnelConfig) {
  ...
  this.httpPath = 'http://stage-downloads.lambdatest.com/tunnel/linux/64bit/ltcomponent.zip'
  this.binaryName = 'ltcomponent.zip'
  var destBinaryName = this.windows ? 'ltcomponent.exe' : 'ltcomponent';
